...
class ZepEntityReader:
    ...
    2. Filter nodes that match predefined entity types (nodes whose Labels include more than just "Entity")
    3. Retrieve related edge and connected node information for each entity
    """
    ...
    def _call_with_retry(
        ...
        Args:
            func: Function to execute (a zero-argument lambda or callable)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all edges related to a given node (with retry mechanism)
        ...
        """
        try:
            # Use the retry mechanism to call the Zep API
    ...
    def filter_defined_entities(
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must include a label other than "Entity" and "Node"
            custom_labels = [l for l in labels if l not in ["Entity", "Node"]]
            
            if not custom_labels:
                # Only default labels; skip this node
                continue
            ...
            if enrich_with_edges:
                ...
                # Retrieve basic information for related nodes
                related_nodes = []
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity along with its full context (edges and related nodes, with retry)
        ...
        """
        try:
            # Use the retry mechanism to get the node
