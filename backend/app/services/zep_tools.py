...
Encapsulates graph search, node retrieval, edge queries, etc. for use by the Report Agent.
...
2. PanoramaSearch (Breadth Search) - Get a full overview, including expired content
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-questions, along with comprehensive analysis
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter junk content with question numbers (questions 1-9)
                skip = False
                for d in '123456789':
                ...
                if skip:
                    continue
                # Truncate overly long content (truncate by period, not hard cut)
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interviews (interview simulated Agents, get multi-perspective insights)
    ...
    def get_simulation_context(
        ...
        Args:
            ...
            limit: Count limit for each type of information
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, automatically decomposes problems and retrieves multi-dimensionally:
    ...
    def _generate_sub_queries(
        ...
        Decompose complex problems into multiple sub-questions that can be independently retrieved
        """
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring understanding of the full picture of events and tracking evolution.
    ...
    def interview_agents(
        ...
        [Use Cases]
        - Need to understand different perspectives on an event from various roles
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer questions one by one in order, start each answer with 'Question X:' (X is the question number)\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplement): Correctly paired Chinese quotes「」with long text
                if not key_quotes:
...
Please generate 3-5 interview questions."""
        ...
        try:
            ...
            return [
                ...
                "How do you think this problem should be resolved or improved?"
            ]
    ...
    def _generate_interview_summary(
        ...
        if not interviews:
            return "No interviews were conducted"
...
- Use quotation marks when citing interviewee's original words
- May use **bold** to highlight key terms, but do not use other Markdown syntax"""
