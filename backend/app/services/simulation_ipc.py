...
1. Flask writes a command to the commands/ directory
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms simultaneously in dual-platform simulations,
                        or interview the single platform in single-platform simulations
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional; overridden by the platform field in each interview item)
                ...
                - None: Each Agent interviews both platforms simultaneously in dual-platform simulations
            timeout: Timeout in seconds
