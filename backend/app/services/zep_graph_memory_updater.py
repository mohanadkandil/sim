...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return directly in "agent_name: activity_description" format, no simulation prefix
...
class ZepGraphMemoryUpdater:
    ...
    All meaningful behaviors are updated to Zep; action_args contains complete context information:
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains complete context information (e.g. post text, usernames).
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "skipped_count": self._skipped_count,        # Activities filtered and skipped (DO_NOTHING)
