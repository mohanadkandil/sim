...
- We need to simulate the reactions of all parties in a public opinion event and the information propagation paths

Therefore, **entities must be real-world subjects that can speak out and interact on social media**:
...
B. **Specific types (8 types, designed based on text content)**:
   - Design more specific types for the major roles appearing in the text
...
- The text will contain various characters such as "primary school teachers", "passersby", "some netizen"
...
- Each specific type should have a clear boundary to avoid overlaps
...
- Person: Any individual (used when the person does not fit the above specific types)
...
- Organization: Any organization (used when the organization does not fit the above specific types)
...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        # If text exceeds 50,000 characters, truncate (only affects what is sent to the LLM; does not affect graph building)
...
4. All entity types must be real-world subjects capable of voicing opinions; they cannot be abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final check: ensure limits are not exceeded (defensive programming)
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by Crucible for social opinion simulation',
            '"""',
            '',
