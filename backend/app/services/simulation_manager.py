...
Manages dual-platform parallel simulations on Twitter and Reddit
...
logger = get_logger('crucible.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description (used by LLM for config generation)
            document_text: Original document content (used by LLM for background understanding)
        ...
        try:
            ...
            # Reddit is already saved in real-time during generation; save once more to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: run scripts remain in backend/scripts/; they are no longer copied to the simulation directory.
            # When starting the simulation, simulation_runner runs the scripts from scripts/.
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate conda environment: conda activate Crucible\n"
